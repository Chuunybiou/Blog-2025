...
<div class="article-layout">
  ...
  <main class="article-content">
    ...
    <p>Si ton conjoint est vietnamien et que vous êtes mariés, tu peux obtenir un <strong>visa TT</strong> valable jusqu'à <strong>5 ans</strong>. C'est la solution la plus simple pour les couples franco-vietnamiens.</p>
    <ul>
    ...
    <p>Quel que soit ton visa, tu es légalement tenu de t'enregistrer auprès du commissariat de police local (<em>công an phường</em>) dans les <strong>24 heures</strong> suivant ton arrivée dans un logement au Vietnam. Cette règle s'applique aussi bien à un hôtel qu'à un appartement loué à un particulier.</p>
    ...
    <div class="faq-item">
      <button class="faq-question" onclick="this.parentElement.classList.toggle('open')">Quel visa pour vivre au Vietnam en tant que Français ? <span class="faq-arrow">▼</span></button>
      <div class="faq-answer">Selon ta situation : l'e-visa pour un séjour jusqu'à 90 jours, le visa de travail si tu as un employeur, ou le visa TT si ton conjoint est vietnamien.</div>
    </div>
    <div class="faq-item">
      <button class="faq-question" onclick="this.parentElement.classList.toggle('open')">Faut-il un visa pour un séjour de moins de 45 jours ? <span class="faq-arrow">▼</span></button>
