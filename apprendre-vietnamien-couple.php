...
<div class="article-layout">
  ...
  <main class="article-content">
    ...
    <p>Si tu veux travailler ce socle méthodiquement, j'ai écrit un cahier d'entraînement entièrement consacré à cette étape — accents, sons, tons et construction des phrases, avec exercices corrigés : <a href="comment-marche-le-vietnamien">« Comment marche le vietnamien ? »</a>. C'est exactement le chapitre que les applications sautent.</p>
