...
<div class="article-layout">
  ...
  <main class="article-content">
    ...
    <p>Un professeur particulier est de loin la méthode la plus efficace pour progresser rapidement, surtout sur les tons. À Hanoï, l'offre est abondante et les tarifs raisonnables :</p>
    <ul>
    ...
    <p>Les échanges linguistiques (tandem) avec des Vietnamiens souhaitant pratiquer le français sont particulièrement efficaces pour la pratique conversationnelle. Cherche sur les groupes Facebook "French-Vietnamese Language Exchange Hanoi".</p>

    <h2 id="section-8">Progresser avec la belle-famille au quotidien</h2>
    <p>La belle-famille est ton meilleur terrain d'entraînement — et souvent le plus intimidant. Quelques approches concrètes :</p>
    <ul>
    ...
    <div class="faq-item">
      <button class="faq-question" onclick="this.parentElement.classList.toggle('open')">Combien de temps pour avoir une vraie conversation en vietnamien ? <span class="faq-arrow">▼</span></button>
      <div class="faq-answer">Avec 30 minutes de pratique quotidienne sérieuse, compte 6 à 12 mois pour des conversations simples, 2 à 3 ans pour une aisance réelle. La phonologie tonale est le principal obstacle — une fois les tons en place, le reste s'accélère.</div>
    </div>
    <div class="faq-item">
