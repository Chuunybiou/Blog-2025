...
.table-wrap,.table-wrapper{overflow-x:auto;-webkit-overflow-scrolling:touch;margin:2.2rem 0;background:var(--white);border:1px solid var(--border);border-top:3px solid var(--{$_c});border-radius:var(--radius);box-shadow:var(--shadow-sm)}
.comparison-table,.table-wrapper table{width:100%;border-collapse:separate;border-spacing:0;font-size:0.92rem;background:var(--white);min-width:420px;margin:0}
.comparison-table thead th,.table-wrapper table thead th{background:var(--warm-bg);color:var(--{$_c});text-align:left;padding:0.95rem 1.25rem;font-size:0.72rem;text-transform:uppercase;letter-spacing:1.5px;font-weight:700;border-bottom:2px solid var(--border);white-space:nowrap}
.comparison-table td,.table-wrapper table td{padding:0.9rem 1.25rem;border-bottom:1px solid var(--border);color:#3a3530;vertical-align:top;line-height:1.55}
.comparison-table tbody tr:last-child td,.table-wrapper table tbody tr:last-child td{border-bottom:none}
.comparison-table tbody tr:hover td,.table-wrapper table tbody tr:hover td{background:var(--warm-bg)}
.comparison-table td:first-child,.table-wrapper table td:first-child{font-weight:600;color:var(--ink)}
.comparison-table td strong,.table-wrapper table td strong{color:var(--ink)}
.comparison-table tbody tr:last-child:has(td strong) td,.table-wrapper table tbody tr:last-child:has(td strong) td{background:var(--warm-bg);border-top:2px solid var(--border)}
@media(max-width:640px){.comparison-table,.table-wrapper table{font-size:0.84rem;min-width:320px}.comparison-table thead th,.comparison-table td,.table-wrapper table thead th,.table-wrapper table td{padding:0.7rem 0.9rem}}
...
.community-cta{background:linear-gradient(135deg,#12172a 0%,#161f12 100%);border-radius:14px;padding:2.25rem 2rem;margin:2.5rem 0;text-align:center}
.community-cta-icon{font-size:2.25rem;margin-bottom:.65rem}
.community-cta h3{font-family:\"DM Serif Display\",serif;font-size:1.15rem;margin-bottom:.4rem;color:#faf8f4}
.community-cta>p{color:rgba(250,248,244,.65);font-size:.88rem;line-height:1.65;margin-bottom:1.25rem;max-width:460px;margin-left:auto;margin-right:auto}
.community-cta-btns{display:flex;gap:.75rem;justify-content:center;flex-wrap:wrap}
.community-btn{display:inline-flex;align-items:center;gap:.5rem;padding:.6rem 1.2rem;border-radius:8px;font-weight:600;font-size:.88rem;text-decoration:none;transition:opacity .2s,transform .2s}
