...
$page_canonical   = SITE_URL . '/carte-residence-temporaire-vietnam';
...
<div class="article-layout">
  <aside class="toc">
    ...
    <ol class="toc-list">
      <li><a href="#section-1">Qu'est-ce que la thẻ tạm trú ?</a></li>
      <li><a href="#section-2">Qui peut l'obtenir ?</a></li>
      <li><a href="#section-3">Documents requis</a></li>
      <li><a href="#section-4">Procédure étape par étape</a></li>
  ...
  <main class="article-content">
    ...
    <table class="comparison-table">
      ...
      <tbody>
        <tr><td>Travail (permis de travail)</td><td>LĐ</td><td>2 ans renouvelable</td></tr>
        <tr><td>Investisseur / représentant commercial</td><td>ĐT</td><td>5 ans renouvelable</td></tr>
        <tr><td>Conjoint(e) de ressortissant vietnamien</td><td>TT</td><td>2 ans renouvelable</td></tr>
        <tr><td>Enfant mineur de ressortissant vietnamien</td><td>TT</td><td>2 ans renouvelable</td></tr>
        <tr><td>Étudiant(e) dans un établissement vietnamien</td><td>DH</td><td>1 an renouvelable</td></tr>
        <tr><td>Expertise technique / coopération internationale</td><td>NN</td><td>1 an renouvelable</td></tr>
      </tbody>
    </table>
    ...
    <div class="info-box">
      <strong>📋 Pour motif conjoint de Vietnamien (TT) :</strong>
      Formulaire NA6 — Passeport valide — Acte de mariage certifié conforme (traduit en vietnamien par traducteur assermenté) — Livret de famille vietnamien (sổ hộ khẩu) du conjoint — 2 photos 4x6 cm fond blanc.
    </div>

    <h2 id="section-4">Procédure étape par étape</h2>
    <ol>
      <li><strong>Rassembler les documents</strong> selon ton motif (voir ci-dessus)</li>
      <li><strong>Déposer le dossier</strong> au Département de l'Immigration de ta province (à Hanoï : 44-46 Trần Phú, Ba Đình)</li>
      <li><strong>Payer les frais</strong> de dossier sur place (~135 000 VND)</li>
    ...
    <ul>
      ...
      <li><strong>Contribution exceptionnelle au Vietnam</strong> : cas rares, sur arrêté du Ministère de la Sécurité publique</li>
    </ul>
    <div class="info-box">
