...
$page_faq = [
  ...
  ['q' => 'Faut-il que la transcription du mariage à Nantes soit terminée avant de déposer le visa ?',
   'a' => 'En théorie oui, car l\'extrait d\'acte de mariage transcrit fait partie du dossier. Dans certains cas, la demande peut être initiée avec un acte de mariage vietnamien légalisé et traduit, mais la transcription est fortement recommandée pour éviter le refus. [À VÉRIFIER] avec VFS Global au moment de ta demande.'],
  ['q' => 'Quels justificatifs de ressources sont acceptés ?',
   'a' => 'Les 3 derniers bulletins de salaire, le dernier avis d\'imposition, et les 3 derniers relevés de compte bancaire. Le seuil minimum de ressources est [À VÉRIFIER] — il est recalculé chaque année.'],
...
<div class="article-layout">
  ...
  <main class="article-content">
    ...
    <p>Cet article fait partie du <a href="faire-venir-conjointe-vietnamienne-france">guide complet sur le regroupement familial franco-vietnamien</a>. Si tu débarques ici directement, lis d'abord le guide général pour avoir la vue d'ensemble.</p>

    <img class="article-photo" src="https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=1200&q=80" alt="Documents administratifs pour visa" width="1200" height="675" loading="lazy">
    ...
    <ul>
      ...
      <li>Tu justifies de ressources suffisantes pour subvenir aux besoins du foyer : seuil [À VÉRIFIER] net mensuel</li>
      <li>Tu justifies d'un logement en France d'une superficie [À VÉRIFIER] m² minimum par occupant</li>
    </ul>
    <div class="tip-box">
      <strong>Ressources insuffisantes ?</strong> Les ressources du conjoint encore au Vietnam peuvent être prises en compte dans certains cas. [À VÉRIFIER] selon le consulat. Si les revenus sont limités, un co-garant ou une attestation de la CAF peuvent aider.
    </div>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Conjoint vietnamien</td>
          <td>Format réglementaire [À VÉRIFIER]</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>Conjoint vietnamien</td>
          <td>Traduit + apostille [À VÉRIFIER]</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>Conjoint vietnamien</td>
          <td>En français ou en anglais [À VÉRIFIER]</td>
        </tr>
        <tr>
    ...
    <p>Les visas de long séjour pour la France sont traités par l'ambassade de France, mais le dépôt physique du dossier se fait via VFS Global — le prestataire mandaté. Il existe des centres VFS Global à Hanoï et à Hô Chi Minh-Ville [À VÉRIFIER adresses actuelles].</p>
    ...
    <p>Le jour du dépôt, ton conjoint doit se présenter seul avec l'intégralité du dossier. Le partenaire français n'est pas obligatoirement présent au dépôt, mais peut accompagner si les règles du centre le permettent [À VÉRIFIER].</p>
    <p>Frais à payer au dépôt :</p>
    <ul>
      <li>Droits de visa : <strong>[À VÉRIFIER] €</strong></li>
      <li>Frais de service VFS Global : <strong>[À VÉRIFIER] €</strong></li>
    </ul>

    <h2 id="section-5">Délais et suivi du dossier</h2>
    <p>Après le dépôt, l'ambassade instruit le dossier. Délai moyen constaté : <strong>[À VÉRIFIER] semaines à [À VÉRIFIER] mois</strong>. Ce délai peut être allongé si l'ambassade demande des documents complémentaires ou convoque ton conjoint à un entretien.</p>
    ...
    <p>Un refus de visa mentionne un motif (ressources insuffisantes, doute sur la réalité du mariage, dossier incomplet…). Tu peux déposer un recours gracieux auprès de l'ambassade dans un délai de <strong>[À VÉRIFIER] mois</strong>, ou un recours contentieux devant la commission de recours contre les refus de visa. Ce recours est gratuit mais peut prendre plusieurs mois.</p>
