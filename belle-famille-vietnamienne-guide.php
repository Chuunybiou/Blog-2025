...
<div class="article-layout">
  ...
  <main class="article-content">
    ...
    <p>Lors de ta première visite chez les parents de ta conjointe, tu seras observé — c'est normal et ne pas le nier. Ils veulent évaluer : est-ce que tu es respectueux ? Est-ce que tu prends soin de leur fille ? Est-ce que tu fais des efforts pour t'intégrer ?</p>
    ...
    <p>Le vietnamien est une langue à pronoms relationnels — les mots pour "je" et "tu" changent selon la relation et l'âge. Pour un Français, la règle la plus importante est d'utiliser les bons termes pour les beaux-parents :</p>
    <ul>
    ...
    <p>Les repas vietnamiens sont familiaux et collectifs — tout le monde partage les plats au centre. Quelques codes à connaître :</p>
    <ul>
    ...
    <p>Apporter un cadeau à chaque visite n'est pas obligatoire, mais apporter quelque chose lors des premières visites et des occasions importantes (Tết, anniversaires, maladies) est très apprécié.</p>
    <ul>
    ...
    <p>Dans de nombreux ménages vietnamiens, les beaux-parents ou grands-parents vivent avec le couple — ou à quelques rues de distance. Pour un Français, l'absence d'espace privé peut être difficile à vivre au quotidien.</p>
    ...
    <p>Les conflits avec la belle-famille arrivent dans tous les couples mixtes. L'important est de ne pas les laisser s'envenimer :</p>
    <ul>
    ...
    <div class="faq-item">
      <button class="faq-question" onclick="this.parentElement.classList.toggle('open')">Comment réagir quand on ne comprend pas la conversation ? <span class="faq-arrow">▼</span></button>
      <div class="faq-answer">Souris, hoche la tête occasionnellement, regarde les personnes qui parlent. Ta conjointe peut te faire de courts résumés. Avec le temps, tu capteras des mots clés en vietnamien. L'essentiel est de ne pas sembler indifférent ou ennuyé.</div>
    </div>
    <div class="faq-item">
      <button class="faq-question" onclick="this.parentElement.classList.toggle('open')">Dois-je aider à faire la vaisselle après le repas ? <span class="faq-arrow">▼</span></button>
      <div class="faq-answer">Proposer toujours — c'est apprécié comme geste. Dans beaucoup de familles, l'invité ne fait pas la vaisselle mais le fait de proposer montre ton éducation. Ta belle-mère dira probablement "non" mais aura retenu le geste. Suis la coutume de ta conjointe.</div>
    </div>
    <div class="faq-item">
      <button class="faq-question" onclick="this.parentElement.classList.toggle('open')">Combien de temps faut-il pour être vraiment accepté dans la famille ? <span class="faq-arrow">▼</span></button>
