  ...
  <article class="article-body">
    ...
    <div class="info-box" style="margin-top:3rem;">
      ...
      <ul style="margin:0.75rem 0 0.5rem;padding-left:1.2rem;">
        <li><a href="banque-vietnam-francais.php">Compte bancaire au Vietnam pour Français : mon analyse</a></li>
        ...
        <li><a href="fiscalite-expat-france-vietnam.php">Fiscalité de l'expatrié France-Vietnam</a></li>
      </ul>
    </div>
