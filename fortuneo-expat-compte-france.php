...
<div class="article-layout">
  ...
  <article class="article-body">
    ...
    <!-- H2 résidence -->
    <p>Petit levier complémentaire tant que tu gardes des achats en ligne côté français (cadeaux famille, commandes livrées en France, abonnements) : le cashback. Quelques euros récupérés sur chaque commande, ça ne change pas une vie mais ça s'additionne — le fonctionnement depuis l'étranger est détaillé dans <a href="igraal-cashback-expat-france">iGraal pour les expatriés</a>.</p>
